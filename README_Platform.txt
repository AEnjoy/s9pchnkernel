...
5. Note : 
   ...
   - SAssistant_downloadable.apk : "S Assistant"
   - SamsungConnect.apk : "SamsungConnect"
   - SamsungCamera.apk : "Camera8"
   - AREmoji.apk : "AREmoji"
   - SBrowser_11.0.apk : "SBrowser" (version : SBrowser v11)      
   - VoiceNote_5.0.apk : "Voice Recorder"
   - Fmm.apk : "FMM"   
   - SamsungMessages_11.apk : "Messaging"
   - SoundPicker.apk, ClipboardEdge.apk: "libgnustl_shared.so"